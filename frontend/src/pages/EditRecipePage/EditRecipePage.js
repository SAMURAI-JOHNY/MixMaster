...
const EditRecipePage = () => {
  ...
  useEffect(() => {
    const loadRecipe = async () => {
      try {
        ...
        const loadedIngredients = recipeData.ingredients && recipeData.ingredients.length > 0
  ...
  const handleRemoveIngredient = (index) => {
    setRecipe(prev => {
      ...
      // Если удалили все ингредиенты, оставляем один пустой
          ...
          <form onSubmit={handleSubmit} className="edit-recipe-form">
            ...
            <div className="form-group">
              ...
              {recipe.ingredients && recipe.ingredients.length > 0 ? (
                ...
                <div style={{ color: '#616161', padding: '10px' }}>Нет ингредиентов. Добавьте ингредиенты ниже.</div>
              )}
              <button
                type="button"
