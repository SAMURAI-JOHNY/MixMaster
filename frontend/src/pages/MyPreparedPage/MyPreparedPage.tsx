      ...
      <div className="my-prepared-container">
        ...
        {preparedCocktails.length === 0 ? (
          <div className="empty-state">
            ...
            <Button onClick={() => navigate('/')}>Перейти к коктейлям</Button>
          </div>
        ) : (
              ...
              >
                <div className="prepared-cocktail-image">
                  {item.cocktail_image_url ? (
                    <ResolvedImage
                      storageUrl={item.cocktail_image_url}
                      fallbackSrc={FallbackCocktailImg}
                ...
                <div className="prepared-cocktail-info">
                  ...
                  <p className="prepared-date">
                    Приготовлен:{' '}
                    {new Date(item.prepared_at).toLocaleDateString('ru-RU', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric',
                      hour: '2-digit',
